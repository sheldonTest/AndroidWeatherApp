package com.aitronics.jetweatherforecast.screens.splash
...
import com.aitronics.jetweatherforecast.R
...
fun WeatherSplashScreen(navController: NavController) {
    ...
    LaunchedEffect(key1 = true, block = {
        //This will make the circle in the surface have a pup up z-axis animation
